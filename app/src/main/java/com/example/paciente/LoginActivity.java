...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Epassword = findViewById(R.id.passwordIL);
        noCuenta = findViewById(R.id.Notienecuenta);
        Sloginbt = findViewById(R.id.btniniciar);
    ...
    private void beginRecovery(String email) {
        ...
        pd.show();
        baseAuth.sendPasswordResetEmail(email).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
    ...
    private void firebaseAuthWithGoogle(GoogleSignInAccount acct) {
        ...
        baseAuth.signInWithCredential(credential)
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    @Override
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (task.getResult().getAdditionalUserInfo().isNewUser()){
                                ...
                                DatabaseReference reference = database.getReference("Paciente");
                                //
